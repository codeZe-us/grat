...
Every Stellar app hits the same problem: users need XLM to pay transaction fees before they can do anything. For apps serving non-crypto users, this breaks onboarding completely. Grat removes that wall.
